                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('admin.update',[$admin->id])}}" method="post">
                                    ...
                                    <div class="form-group row">
                                        <label for="role" class="col-md-4 col-form-label text-md-right">Specialization</label>
                                        <input type="text" value="{{ $admin->specialization }}" name="specialization" class="form-control col-md-6" id="role">
                                    </div>
