...
<head>
    ...
    <style>
        .bg-login-image{
            background: url("https://image.freepik.com/free-vector/medical-professionals-appreciation_23-2148503890.jpg");
                            ...
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="{{ route('admin.login') }}">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <hr>
                                        <a href="/" class="btn btn-success btn-user btn-block">Home</a>
