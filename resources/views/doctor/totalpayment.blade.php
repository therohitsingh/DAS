                ...
                <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-5 col-sm-7 col-xl-8 p-0">
                            <h4 class="mb-1 mb-sm-0"> {{ auth('admin')->user()->name }},Your Total Payment for this Month is !</h4>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h1><center><span>₹{{$data+$data1}}</span></center></h1>
                        <br>
                        <br>
                   <center> <td><a class="btn  btn-danger" href="{{url('/doctor/deleteappointment/')}}">Redeem</a></td></center>
                    </tbody>
                </div>
            </div>
        </div>
