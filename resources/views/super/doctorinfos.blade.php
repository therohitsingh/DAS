                        ...
                        <div class="card-body py-0 px-0 px-sm-3">
                            <div class="row align-items-center">
                                ...
                                <div class="col-5 col-sm-7 col-xl-8 p-0">
                                    <h3 class="mb-1 mb-sm-0"> {{ auth('admin')->user()->name }}, We Have Total {{$count}} Doctors</h3>
                            ...
                            {
                                                                @endphp
                                                                <img src="{{ url('/upload/'.$data3->image) }}" style="height: 70px; width: 70px; border-radius: 100%;">
                                                                @php }else{ @endphp
