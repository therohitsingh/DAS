...
">
                        <div class="card-body py-0 px-0 px-sm-3">
                            <div class="row align-items-center">
                                ...
                                <div class="col-5 col-sm-7 col-xl-8 p-0">
                                    <h4 class="mb-1 mb-sm-0"> {{ Auth::user()->name }}, Search Doctor for Appointment</h4>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{url('/dashboard/searchdoc')}}" method="post" role="search">
                        @if(session('message'))
                    ...
                    <div class="table-responsive">
                        @if(isset($details))
                                        ...
                                        <td>@php if(!empty($user->image))
                            {
                                        ...
                                        <td><a class="btn btn-warning btn-rounded btn-fw" href="{{url('/dashboard/appointment/'.$user->id)}}">Appointment</a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
