...
">
                            <div class="card-body py-0 px-0 px-sm-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-5 col-sm-7 col-xl-8 p-0">
                                        <h4 class="mb-1 mb-sm-0"> {{ Auth::user()->name }} Want Organ ?</h4>
                                        <p class="mb-0 font-weight-normal d-none d-sm-block">{{ Auth::user()->name }} Search Donor by Organ   {{ Auth::user()->name }}  </p>
                                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{url('/dashboard/searchdor')}}" method="post" role="search">
                        @if(session('message'))
