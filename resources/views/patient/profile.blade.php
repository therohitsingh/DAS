@extends('dashboard.master') @section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="card" style="background-color: #FF3CAC;
                                ...
                                <div class="col-md-8">
                                    ...
                                    @foreach($data as $datas)
                                        ...
                                        @else
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label style="color: black;font-family:'ROG Fonts'">Address</label>
                                                </div>
                                                <div class="col-md-6">
                                                    <p>{{$datas->address}}</p>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label style="color: black;font-family: 'ROG Fonts'">Blood Group</label>
                                                </div>
                                                <div class="col-md-6">
                                                    <p>{{$datas->blood}}</p>
                                                </div>
